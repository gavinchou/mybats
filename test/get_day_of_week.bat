...
set n=-1 
::for %%w in (日 一 二 三 四 五 六) do (set /a n+=1 
for %%w in (Sun Mon Tue Wen Thu Fri Sat) do (set /a n+=1 
cls 
::echo %y%年%m%月%d%日 周 
echo 2013-06-13  
goto start 
